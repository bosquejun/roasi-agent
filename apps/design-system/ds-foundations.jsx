  ...
  return (
    <section style={{ marginBottom: 80 }}>
      <SectionTitle
        id="colors"
        label="Color System"
        sub="Built from the brand's fire palette. Every color has a purpose — no decorative noise."
      />
...
const TypeSpecimen = ({ size, label, weight, family, sample, token }) => (
  ...
  >
    ...
    <div
      style={{
        fontFamily:
          family === "pixel" ? "var(--font-pixel)" : "var(--font-mono)",
        fontSize: size,
        fontWeight: weight,
        color: "var(--text-primary)",
        flex: 1,
  ...
  return (
    <section style={{ marginBottom: 80 }}>
      <SectionTitle
        id="typography"
        label="Typography"
        sub="Two fonts, zero compromise. Press Start 2P for brand moments. Space Mono for everything readable."
      />
      ...
      >
        ...
        >
          ...
          >
            Used for headings, labels, score numbers, and brand moments.
            Pixel-native. Never for long text.
          </div>
          <code
            style={{
              display: "block",
        ...
        >
          ...
          >
            Used for body copy, UI labels, metadata, code. Monospace grid
            reinforces the pixel aesthetic while staying readable.
          </div>
          <code
            style={{
              display: "block",
      ...
      >
        ...
        <TypeSpecimen
          ...
          weight={400}
          family="pixel"
          sample="Your Score: 23/100"
          token="--text-2xl / pixel"
        />
        <TypeSpecimen
          size={16}
          label="Heading 2"
        ...
        <TypeSpecimen
          ...
          weight={400}
          family="pixel"
          sample="SUBMITTED 2H AGO"
          token="--text-2xs / pixel"
        />
        <TypeSpecimen
          size={14}
          label="Body"
          weight={400}
          family="mono"
          sample="Your hero headline is too vague. Users can't tell what you do in 5 seconds."
          token="--text-base / mono 400"
        />
        <TypeSpecimen
          size={14}
          label="Body Bold"
          weight={700}
          family="mono"
          sample="Navigation is broken on mobile. Immediate fix needed."
          token="--text-base / mono 700"
        />
        <TypeSpecimen
          size={12}
          label="Caption"
          weight={400}
          family="mono"
          sample="3 community votes · @pixel_dev · submitted via Roasi"
          token="--text-sm / mono 400"
        />
      </div>
    </section>
  )
  ...
  return (
    <section style={{ marginBottom: 80 }}>
      <SectionTitle
        id="spacing"
        label="Spacing"
        sub="8px base grid. All layout spacing is a multiple of 4px."
      />
      <div
        style={{
          display: "flex",
  ...
  return (
    <section style={{ marginBottom: 80 }}>
      <SectionTitle
        ...
        sub="Hard offset shadows — the neo-brutal signature. No blur radius. No softness. Just weight."
      />
      ...
      <div style={{ marginTop: 48 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {[
            { name: "border", val: "3px solid #0A0A0A" },
            { name: "border-thick", val: "4px solid #0A0A0A" },
            { name: "border-xl", val: "5px solid #0A0A0A" },
          ].map((b) => (
            <div
              key={b.name}
