    ...
    <div className="flex h-svh flex-col overflow-hidden">
      ...
      <header className="sticky top-0 z-10 flex h-14 w-full shrink-0 items-center border-0 px-6">
        <div className="mx-auto flex w-full max-w-5xl items-center justify-between">
          <span className="font-pixelated text-fire-red text-text-xs uppercase tracking-widest">
      ...
      <main className="flex flex-1 flex-col items-center justify-center gap-6 px-4">
        <h1 className="text-center font-pixelated text-fire-red text-text-4xl uppercase leading-tight tracking-wider">
          YOUR STARTUP IS
          <br />
          PROBABLY TRASH.
        </h1>
        <p className="text-center font-mono text-charcoal text-text-base">
          Let&apos;s roast it.
        </p>
        ...
        <p className="text-center font-mono text-slate text-text-xs">
